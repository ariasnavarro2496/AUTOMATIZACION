...
Navigate To Main Page
    ...
    Run Process    python    AutomatizacionALTASVTR/HistorialRutVTR/HistorialRutVTR3PLAY.py 
    ...
    Run Process    python    AutomatizacionALTASVTR/InsertarCapture/Insert_VTR3Play.py 
    Sleep    3s
