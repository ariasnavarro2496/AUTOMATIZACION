...
Navigate To Main Page
    ...
    Run Process    python    AutomatizacionALTASVTR/HistorialRutVTR/HistorialRutVTR1PLAY.py 
    ...
    Run Process    python    AutomatizacionALTASVTR/InsertarCapture/Insert_VTR1Play.py 
    Sleep    3s
