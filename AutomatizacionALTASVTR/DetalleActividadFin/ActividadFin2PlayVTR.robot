...
Navigate To Main Page
    ...
    Run Process    python    AutomatizacionALTASVTR/HistorialRutVTR/HistorialRutVTR2PLAY.py 
    ...
    Run Process    python    AutomatizacionALTASVTR/InsertarCapture/Insert_VTR2Play.py 
