...
if __name__ == "__main__":
    docx_path = 'AutomatizacionALTASVTR/ALTA2PLAY_VTR.docx'
    text_image_pairs = [
        ("Se Añade dirección de la promoción y se suma el alta play 2", 'AutomatizacionALTASVTR/Evidencia_VTRscreenshots/captura1.png'),
