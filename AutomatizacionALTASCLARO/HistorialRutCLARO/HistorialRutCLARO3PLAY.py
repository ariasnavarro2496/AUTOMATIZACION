...
def actualizar_archivo_general(archivo_especifico, archivo_general):
    ...
    contenido_formateado = f'{contenido}  -  Alta 3PLAY CLARO  {fecha_hora_actual}\n '
...
# Ejemplo de uso
archivo_especifico = 'AutomatizacionALTASCLARO/ID_CLARO.txt'
archivo_general = 'AutomatizacionALTASCLARO/HistorialRutCLARO.txt'
