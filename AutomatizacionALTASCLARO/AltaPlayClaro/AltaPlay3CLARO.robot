...
Login
    ...
    Run Process    python   AutomatizacionALTASCLARO/Documentacion/Alta3PlayDoc.py
...
Sales Orders - Examine Catalog
    ...
    Sleep    10S     #PROMO3PLAYHFC
    Click Element       xpath://*[@id="ti_1.5_anchor"]
    Sleep    10S   #PACK VIVE RESIDENCIAL
    Click Element       xpath://td[@id='2_s_6_l_Product_Name']
