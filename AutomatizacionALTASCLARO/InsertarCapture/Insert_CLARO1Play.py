...
if __name__ == "__main__":
    docx_path = 'AutomatizacionALTASCLARO/ALTA1PLAY_CLARO.docx'
    text_image_pairs = [
        ("Se Añade dirección de la promoción y se suma el alta play 1", 'AutomatizacionALTASCLARO/Evidencia_CLAROscreenshots/captura1.png'),
