...
Navigate To Main Page
    ...
    Run Process    python    AutomatizacionALTASCLARO/HistorialRutCLARO/HistorialRutCLARO3PLAY.py
    ...
    Run Process    python    AutomatizacionALTASCLARO/InsertarCapture/Insert_CLARO3Play.py 
    Sleep    6s
