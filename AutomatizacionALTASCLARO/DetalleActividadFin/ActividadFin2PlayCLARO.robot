...
Navigate To Main Page
    ...
    Run Process    python    AutomatizacionALTASCLARO/HistorialRutCLARO/HistorialRutCLARO2PLAY.py
    ...
    Run Process    python    AutomatizacionALTASCLARO/InsertarCapture/Insert_CLARO2Play.py 
    Sleep    6s
