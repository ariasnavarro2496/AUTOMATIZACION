...
${SCREENSHOT_DIR}    AutomatizacionSuspencionReconexion/Evidencia_RECONEXION\screenshots
...
Login
    ...
    Run Process    python   AutomatizacionSuspencionReconexion/Documentacion/Reconexion.py
...
Navigate To Main Page
    ...
    Sleep    5s
    Click Element    xpath://li[a[text()='Reanudar']]
    ...
    Go Back
    Sleep    3s
    Pause Execution    SERVICIO DE REANUDACION COMPLETADO
    #CAPTURE DE PANTALLA
    Capture Page Screenshot    ${SCREENSHOT_DIR}/captura4.png  
    Sleep    2s
    Run Process    python    AutomatizacionSuspencionReconexion/InsertarCapture/Reconexion.py 
    Sleep    3s